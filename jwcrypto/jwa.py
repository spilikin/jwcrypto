...
class _BP384R1(_RawEC, JWAAlgorithm):
    ...
    name = "BP384R1"
    description = "ECDSA using Brainpool384R1 curve and SHA-256"
    keysize = 384
    algorithm_usage_location = 'alg'
    algorithm_use = 'sig'

    def __init__(self):
        super(_BP384R1, self).__init__('BP-384', hashes.SHA256())


class _BP512R1(_RawEC, JWAAlgorithm):

    name = "BP512R1"
    description = "ECDSA using Brainpool512R1 curve and SHA-256"
    keysize = 512
    algorithm_usage_location = 'alg'
    algorithm_use = 'sig'

    def __init__(self):
        super(_BP512R1, self).__init__('BP-512', hashes.SHA256())
